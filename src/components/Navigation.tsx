    ...
    <nav className="border-b bg-secondary px-6 py-4 shadow-lg">
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        <div className="flex items-center space-x-8">
          ...
          <div className="flex items-center space-x-6">
            ...
            <Button 
              ...
              className="flex items-center space-x-1 text-white hover:text-primary hover:bg-secondary/80"
            >
        ...
        <div className="flex items-center space-x-4">
          <Button variant="outline" className="border-white text-white hover:bg-white hover:text-secondary">Masuk</Button>
