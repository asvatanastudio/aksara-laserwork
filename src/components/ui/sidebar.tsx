...
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from "./sheet.js"; // Diperbaiki
import { Skeleton } from "./skeleton.js"; // Diperbaiki
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "./tooltip.js"; // Diperbaiki
...
type SidebarContextProps = {
  ...
  open: boolean;
  setOpen: (open: boolean | ((prev: boolean) => boolean)) => void; // Ditingkatkan untuk menerima fungsi
  openMobile: boolean;
